export default {
  ...
  "fmtKind_image": "Image {0}",
  "fmtKind_audio": "Audio {0}",
  "fmtKind_video": "Vidéo {0}",
  "fmtKind_archive": "Archive {0}",
  "fmtKind_font": "Police {0}",
  "fmtKind_document": "Document {0}",
  "fmtKind_book": "Livre {0}",
  "fmtKind_workbook": "Classeur {0}",
  "fmtKind_deck": "Présentation {0}",
  "fmtKind_database": "Base de données {0}",
  "fmtKind_block": "Bloc {0}",
  "fmtKind_binary": "Binaire {0}",
  "fmtKind_executable": "Exécutable {0}",
  "fmtLabel_Binary": "Binaire",
  "fmtLabel_Plaintext": "Texte brut",
  "fmtLabel_Icon": "Icône",
  "button_swap": "Renvoyer le résultat vers l’entrée",
