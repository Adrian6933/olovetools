export default {
  ...
  "custom_desc": "Choisissez la période : un nombre d’heures ou de jours en arrière",
  "custom_label": "Afficher les clips des",
  "custom_amount": "Quantité",
  "custom_unit": "Unité",
  "unit_hours": "Heures",
  "unit_days": "Jours",
  "custom_hours_one": "Dernière heure",
  "custom_hours_other": "{n} dernières heures",
  "custom_days_one": "Dernier jour",
  "custom_days_other": "{n} derniers jours",
  "custom_invalid": "Saisissez un nombre entier entre 1 et {max}",
  "custom_clear": "Retirer la période personnalisée",
  ...
  "range_toggle": "Par jours",
  "range_toggle_desc": "Choisir des jours précis dans un calendrier au lieu des dernières 24 heures, 7 ou 30 jours",
  "range_mode_days": "Jours précis",
  "range_mode_range": "Du – au",
  "range_pick_days": "Touchez les jours voulus ; seuls ceux-là s’affichent",
  "range_pick_start": "Choisissez le premier jour",
  "range_pick_end": "Puis le dernier jour, ou appliquez celui-ci seul",
  "range_apply": "Appliquer",
  "range_cancel": "Annuler",
  "range_clear": "Retirer les jours et revenir à 24 heures / 7 jours",
  "range_prev_month": "Mois précédent",
  "range_next_month": "Mois suivant",
  "range_day_count_one": "1 jour",
  "range_day_count_other": "{n} jours",
