export default {
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Les prochaines exécutions sont calculées localement dans votre navigateur en avançant minute par minute et en comparant chaque champ à votre expression, jusqu'à 5 ans à l'avance."
    }
  ],
