export default {
  ...
  "fmtKind_image": "Imagen {0}",
  "fmtKind_audio": "Audio {0}",
  "fmtKind_video": "Vídeo {0}",
  "fmtKind_archive": "Archivo comprimido {0}",
  "fmtKind_font": "Fuente {0}",
  "fmtKind_document": "Documento {0}",
  "fmtKind_book": "Libro {0}",
  "fmtKind_workbook": "Libro de {0}",
  "fmtKind_deck": "Presentación de {0}",
  "fmtKind_database": "Base de datos {0}",
  "fmtKind_block": "Bloque {0}",
  "fmtKind_binary": "Binario {0}",
  "fmtKind_executable": "Ejecutable de {0}",
  "fmtLabel_Binary": "Binario",
  "fmtLabel_Plaintext": "Texto plano",
  "fmtLabel_Icon": "Icono",
