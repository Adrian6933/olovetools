export default {
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Las próximas ejecuciones se calculan localmente en tu navegador iterando minuto a minuto y comparando cada campo con tu expresión, hasta 5 años en el futuro."
    }
  ],
