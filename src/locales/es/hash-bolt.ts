export default {
  ...
  "seo_title": "HashBolt | Generador de Hash MD5, SHA-1, SHA-256 Gratis Online",
  "seo_description": "Calcula hashes criptográficos (MD5, SHA-1, SHA-256, SHA-512) para textos y archivos 100% en local dentro de tu navegador."
};
