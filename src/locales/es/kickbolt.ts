export default {
  ...
  "quickLinks": ["Kick a MP4", "Descargar Clips", "Descarga Masiva", "Guardar Clips", "Descargar 1080p", "Herramientas Streamer", "Kick a TikTok", "Descarga Móvil", "Conversor Rápido", "Ver Kick Offline"],
  "seoTags": ["DESCARGADOR KICK", "MP4 HD", "DESCARGA MASIVA", "SIN LOGIN", "HERRAMIENTA GRATIS", "1080P", "CLIPS KICK", "KIT EDITOR", "CONVERSOR TIKTOK", "VIDEO GAMING", "CREADOR REELS", "KIT STREAMING", "ALTA DEFINICIÓN", "DESCARGA DIRECTA", "DESCARGA RÁPIDA", "LISTO PARA MÓVIL", "GUARDAR KICK", "CONVERSOR CLIPS", "SIN MARCA DE AGUA", "MEJOR HERRAMIENTA KICK"],
  "legal": {
    "privacy": "Privacidad",
    "terms": "Términos",
    "cookies": "Cookies",
