export default {
  ...
  "error_no_subtitles": "No se encontraron subtítulos válidos. Revisa el formato e inténtalo de nuevo.",
  "error_parse": "Error al analizar los subtítulos.",
  "format_auto": "Auto",
  "label_input": "Subtítulos de entrada",
  "placeholder_input": "Pega tus subtítulos aquí (SRT, VTT o SBV)...",
  "unit_cues": "entradas",
  "label_output": "Salida convertida",
  "tooltip_copy": "Copiar",
  "button_download": "Descargar",
  "placeholder_output": "Los subtítulos convertidos aparecerán aquí...",
