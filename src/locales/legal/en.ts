export default {
  privacy: {
    ...
    description: "Comprehensive privacy policy for oLoveTools.",
    content: `
  ...
  terms: {
    ...
    description: "Terms and conditions for using oLoveTools.",
    content: `
      <h2>1. Terms</h2>
  ...
  about: {
    title: "About oLoveTools",
    description: "Learn more about our mission and the tools we provide.",
    content: `
      <h2>Our Mission</h2>
