export default {
  privacy: {
    ...
    description: "Política de privacidad detallada para oLoveTools.",
    content: `
  ...
  terms: {
    ...
    description: "Términos y condiciones para el uso de oLoveTools.",
    content: `
      <h2>1. Términos</h2>
  ...
  cookies: {
    ...
    description: "Información sobre nuestro uso de cookies y tecnologías de seguimiento.",
    content: `
  ...
  about: {
    title: "Sobre oLoveTools",
    description: "Conozca más sobre nuestra misión y las herramientas que ofrecemos.",
    content: `
