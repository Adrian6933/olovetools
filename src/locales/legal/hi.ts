export default {
  privacy: {
    ...
    content: `
      ...
      <p>हमारे अधिकांश उपकरणों (जैसे Clipy, TwitchBolt, FormatFlow और PasteSnap) के लिए, प्रसंस्करण पूरी तरह से आपके ब्राउज़र में होता है। हम आपके क्लिप, चित्र या स्वरूपित कोड हमारे सर्वर पर संग्रहीत नहीं करते हैं।</p>
      <br/>
  ...
  terms: {
    ...
    content: `
      ...
      <p>हमारे कुछ उपकरण (उदा. Clipy, TwitchBolt) तृतीय-पक्ष API (जैसे Twitch) के साथ इंटरैक्ट करते हैं। इन उपकरणों का उपयोग करके, आपको उन तृतीय-पक्ष प्लेटफार्मों की संबंधित सेवा की शर्तों का भी पालन करना होगा। हम इन API के माध्यम से प्राप्त मीडिया सामग्री को होस्ट या स्वामित्व नहीं रखते हैं।</p>
    `
  },
  cookies: {
    title: "कुकीज़ नीति",
  ...
  about: {
    ...
    content: `
      ...
      <h2>उपकरण</h2>
      <ul>
        <li><strong>Clipy और TwitchBolt:</strong> आसानी से अपने पसंदीदा ट्विच क्लिप खोजें, व्यवस्थित करें और डाउनलोड करें।</li>
