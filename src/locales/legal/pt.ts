export default {
  privacy: {
    ...
    description: "Política de privacidade abrangente para oLoveTools.",
    content: `
      <h2>1. Introdução</h2>
  ...
  terms: {
    ...
    description: "Termos e condições de uso da oLoveTools.",
    content: `
      <h2>1. Termos</h2>
  ...
  cookies: {
    ...
    description: "Informações sobre o nosso uso de cookies e tecnologias de rastreamento.",
    content: `
  ...
  about: {
    title: "Sobre a oLoveTools",
    description: "Saiba mais sobre a nossa missão e as ferramentas que oferecemos.",
    content: `
      <h2>Nossa Missão</h2>
