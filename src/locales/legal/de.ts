export default {
  privacy: {
    ...
    description: "Umfassende Datenschutzrichtlinie für oLoveTools.",
    content: `
      <h2>1. Einleitung</h2>
  ...
  terms: {
    ...
    description: "Allgemeine Geschäftsbedingungen für die Nutzung von oLoveTools.",
    content: `
      <h2>1. Bedingungen</h2>
  ...
  cookies: {
    ...
    description: "Informationen über unsere Verwendung von Cookies und Tracking-Technologien.",
    content: `
  ...
  about: {
    title: "Über oLoveTools",
    description: "Erfahren Sie mehr über unsere Mission und die von uns angebotenen Tools.",
    content: `
