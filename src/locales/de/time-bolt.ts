export default {
  "title": "Time-Bolt",
  "seo_title": "Time-Bolt | Zeit zwischen weltweiten Zeitzonen umrechnen mit interaktivem Meeting-Planer 100% lokal.",
  ...
  "seoKeywords": ["time bolt", "online-tool", "kostenlos", "lokal", "browser"],
  ...
  "faq": [
    ...
    {
      "question": "Berücksichtigt Time-Bolt die Sommerzeit?",
      "answer": "Ja. Time-Bolt verwendet die native Intl-API Ihres Browsers, die Sommerzeit und historische Offset-Änderungen für jede Zeitzone automatisch verwaltet."
    }
  ],
