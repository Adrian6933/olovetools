export default {
  ...
  "fmtKind_image": "{0}-Bild",
  "fmtKind_audio": "{0}-Audio",
  "fmtKind_video": "{0}-Video",
  "fmtKind_archive": "{0}-Archiv",
  "fmtKind_font": "{0}-Schrift",
  "fmtKind_document": "{0}-Dokument",
  "fmtKind_book": "{0}-Buch",
  "fmtKind_workbook": "{0}-Arbeitsmappe",
  "fmtKind_deck": "{0}-Präsentation",
  "fmtKind_database": "{0}-Datenbank",
  "fmtKind_block": "{0}-Block",
  "fmtKind_binary": "{0}-Binärdatei",
  "fmtKind_executable": "{0}-Programmdatei",
  "fmtLabel_Binary": "Binärdaten",
  "fmtLabel_Plaintext": "Reiner Text",
  "fmtLabel_Icon": "Symbol",
