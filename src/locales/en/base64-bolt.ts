export default {
  ...
  "fmtKind_image": "{0} image",
  "fmtKind_audio": "{0} audio",
  "fmtKind_video": "{0} video",
  "fmtKind_archive": "{0} archive",
  "fmtKind_font": "{0} font",
  "fmtKind_document": "{0} document",
  "fmtKind_book": "{0} book",
  "fmtKind_workbook": "{0} workbook",
  "fmtKind_deck": "{0} deck",
  "fmtKind_database": "{0} database",
  "fmtKind_block": "{0} block",
  "fmtKind_binary": "{0} binary",
  "fmtKind_executable": "{0} executable",
  "fmtLabel_Binary": "Binary",
  "fmtLabel_Plaintext": "Plain text",
  "fmtLabel_Icon": "Icon",
  "button_swap": "Send the result back to the input",
