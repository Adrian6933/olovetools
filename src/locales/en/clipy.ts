export default {
  ...
  "time_all": "All Time",
  "time_custom": "Custom",
  "custom_desc": "Choose your own period: a number of hours or days back",
  "custom_label": "Show clips from the",
  "custom_amount": "Amount",
  "custom_unit": "Unit",
  "unit_hours": "Hours",
  "unit_days": "Days",
  "custom_hours_one": "Last hour",
  "custom_hours_other": "Last {n} hours",
  "custom_days_one": "Last day",
  "custom_days_other": "Last {n} days",
  "custom_invalid": "Enter a whole number between 1 and {max}",
  "custom_clear": "Remove the custom period",
  ...
  "range_toggle": "By days",
  "range_toggle_desc": "Pick specific days on a calendar instead of the last 24 hours, 7 or 30 days",
  "range_mode_days": "Specific days",
  "range_mode_range": "From – to",
  "range_pick_days": "Tap the days you want; only those are shown",
  "range_pick_start": "Pick the first day",
  "range_pick_end": "Now the last day, or apply just that one",
  "range_apply": "Apply",
  "range_cancel": "Cancel",
  "range_clear": "Remove the days and go back to 24 hours / 7 days",
  "range_prev_month": "Previous month",
  "range_next_month": "Next month",
  "range_day_count_one": "1 day",
  "range_day_count_other": "{n} days",
