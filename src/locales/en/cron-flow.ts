export default {
  ...
  "seoKeywords": ["cron flow", "online tool", "free", "local", "browser"],
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Next executions are computed locally in your browser by iterating forward minute by minute and matching each field against your expression, up to 5 years ahead."
    }
  ],
  "footerTagline": "Generate, translate and visualize cron expressions with human-readable descriptions 100% locally.",
