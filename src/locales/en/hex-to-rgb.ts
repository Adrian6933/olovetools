export default {
  ...
  "seo_title": "HEX to RGB Converter | RGB, HSL, OKLCH and CMYK",
  ...
  "shortcuts": [
    {
      "keys": "1 – 8",
      "label": "Jump to that palette slot"
    },
    {
    ...
    {
      "keys": "Alt",
      "label": "Hold to preview the complement"
    },
    {
      "keys": "Click",
      "label": "Hold on the swatch to compare with the starting colour"
    },
    {
      "keys": "Right click",
      "label": "Flip a palette slot to its complement"
    },
    {
      "keys": "C",
      "label": "Copy the hex code"
    },
    {
      "keys": "E",
      "label": "Open the screen eyedropper"
    },
    {
      "keys": "?",
