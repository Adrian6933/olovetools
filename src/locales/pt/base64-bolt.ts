export default {
  "downloadFile": "Baixar",
  "fmtKind_image": "Imagem {0}",
  "fmtKind_audio": "Áudio {0}",
  "fmtKind_video": "Vídeo {0}",
  "fmtKind_archive": "Arquivo compactado {0}",
  "fmtKind_font": "Fonte {0}",
  "fmtKind_document": "Documento {0}",
  "fmtKind_book": "Livro {0}",
  "fmtKind_workbook": "Pasta de trabalho do {0}",
  "fmtKind_deck": "Apresentação do {0}",
  "fmtKind_database": "Banco de dados {0}",
  "fmtKind_block": "Bloco {0}",
  "fmtKind_binary": "Binário {0}",
  "fmtKind_executable": "Executável do {0}",
  "fmtLabel_Binary": "Binário",
  "fmtLabel_Plaintext": "Texto simples",
  "fmtLabel_Icon": "Ícone",
  "button_swap": "Enviar o resultado de volta à entrada",
