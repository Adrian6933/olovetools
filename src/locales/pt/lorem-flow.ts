export default {
  ...
  "message_empty": "Pressione Gerar para criar texto Lorem Ipsum.",
  ...
  "faq": [
    ...
    {
      "question": "Posso baixar o texto gerado como arquivo?",
      "answer": "Sim. Após gerar o texto, clique em Baixar .txt para salvar a saída como arquivo de texto simples pronto para colar nos seus designs ou maquetes."
    }
  ],
