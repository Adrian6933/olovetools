export default {
  ...
  "modeUrl": "URL / Link",
  "modeText": "Texto Simples",
  "modeWifi": "Rede WiFi",
  "modeEmail": "Modelo de Email",
  "modeSms": "Mensagem SMS",
  "placeholderUrl": "Insira a URL do site (ex. https://example.com)",
  "placeholderText": "Digite sua mensagem aqui...",
  "labelWifiSsid": "Nome da Rede (SSID)",
  "labelWifiPassword": "Senha",
  "labelWifiSecurity": "Tipo de Segurança",
  "labelEmailAddress": "Email do Destinatário",
  "labelEmailSubject": "Assunto",
  "labelEmailBody": "Corpo da Mensagem",
  "labelSmsNumber": "Número de Telefone",
  "labelSmsMessage": "Mensagem SMS",
  "labelDotType": "Estilo dos Pontos",
  "labelCornerType": "Estilo do Quadro Externo",
  "labelCornerDotType": "Estilo do Ponto Interno",
  "labelColorType": "Tipo de Preenchimento",
  "colorSolid": "Cor Sólida",
  "colorGradient": "Cor em Degradê",
  "labelMainColor": "Cor dos Pontos",
  "labelBgColor": "Cor de Fundo",
  "labelGradientType": "Estilo de Degradê",
  "gradLinear": "Degradê Linear",
  "gradRadial": "Degradê Radial",
  "labelGradientColor1": "Cor Inicial",
  "labelGradientColor2": "Cor Final",
  "labelGradientRotation": "Ângulo (Graus)",
  "labelUploadLogo": "Enviar Imagem Personalizada",
  "labelPresetLogo": "Logotipo de Marca Predefinido",
  "logoPresetNone": "Sem Logo",
  "labelLogoSize": "Tamanho do Logo",
  "labelLogoMargin": "Margem do Logo",
  "labelClearDots": "Limpar pontos atrás do logo (Recomendado)",
  "downloadBtnPng": "Baixar PNG",
  "downloadBtnSvg": "Baixar SVG",
  "downloadBtnJpg": "Baixar JPEG",
  "resetBtn": "Reiniciar",
  "statusInit": "Insira os dados para gerar seu código QR personalizado...",
  "statusDone": "Seu código QR personalizado está pronto!",
  "statusError": "Não foi possível compilar a configuração do QR. Verifique seus dados.",
  "features": [
    {
      "title": "Personalização Incrível",
      "text": "Modifique padrões, quadros e fundos com degradês coloridos e logotipos de marcas."
    },
    {
      "title": "100% Local e Seguro",
      "text": "Seus dados e logotipos são processados na memória do seu navegador. Seus arquivos nunca chegam ao servidor."
    },
    {
      "title": "Vetor SVG pronto para Impressão",
      "text": "Baixe arquivos PNG/JPEG de alta resolução ou vetoriais SVG escaláveis ideais para impressão profissional."
    }
  ],
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "Sim. Você pode enviar imagens em formato PNG, JPEG ou WebP, ou selecionar um dos nossos logotipos predefinidos de redes sociais."
    },
    {
      "question": "Como garantir que meu código QR seja legível?",
      "answer": "Certifique-se de que haja um forte contraste entre os padrões e o fundo (padrões escuros sobre fundo claro leem melhor). Mantenha o tamanho do logotipo abaixo de 25%."
    },
    {
      "question": "Como funciona o código QR de WiFi?",
      "answer": "Ao escanear com a câmera do iOS ou Android, o dispositivo identifica as configurações e solicita a conexão automática à rede SSID sem precisar digitar a senha."
    }
  ],
