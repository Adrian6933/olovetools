export default {
  ...
  "faq": [
    ...
    },
    {
      ...
      "answer": "As próximas execuções são calculadas localmente no seu navegador avançando minuto a minuto e comparando cada campo com sua expressão, até 5 anos à frente."
    }
  ],
