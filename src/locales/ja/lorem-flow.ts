export default {
  ...
  "label_words": "単語",
  "message_empty": "Lorem Ipsum テキストを作成するには生成を押してください。",
  ...
  "faq": [
    ...
    {
      "question": "生成したテキストをファイルとしてダウンロードできますか？",
      "answer": "はい。テキスト生成後、.txt をダウンロードをクリックすると、デザインやモックアップに貼り付け可能なプレーンテキストファイルとして出力を保存できます。"
    }
  ],
