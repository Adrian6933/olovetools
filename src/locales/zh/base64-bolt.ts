export default {
  ...
  "fmtKind_audio": "{0} 音频",
  "fmtKind_video": "{0} 视频",
  "fmtKind_archive": "{0} 压缩包",
  "fmtKind_font": "{0} 字体",
  "fmtKind_document": "{0} 文档",
  "fmtKind_book": "{0} 电子书",
  "fmtKind_workbook": "{0} 工作簿",
  "fmtKind_deck": "{0} 演示文稿",
  "fmtKind_database": "{0} 数据库",
  "fmtKind_block": "{0} 块",
  "fmtKind_binary": "{0} 二进制文件",
  "fmtKind_executable": "{0} 可执行文件",
  "fmtLabel_Binary": "二进制数据",
  "fmtLabel_Plaintext": "纯文本",
  "fmtLabel_Icon": "图标",
  "button_swap": "把结果放回输入框",
  "resetHint": "重新开始",
  "title": "Base64Bolt",
