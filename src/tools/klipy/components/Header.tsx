      ...
      <header className="w-full h-auto md:h-24 py-4 md:py-0 border-b border-white/10 bg-[#020a08]/95 backdrop-blur-3xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] pointer-events-auto">
        <div className="max-w-7xl mx-auto h-full px-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
          <div className="flex items-center justify-between w-full md:w-auto gap-3 md:gap-12 min-w-0">
            ...
            {/* Deliberately not a button: this used to be wired to a reset that
                threw you back to the category list, so clicking what looks like
                the tool name lost whatever you were looking at. */}
            <div className="flex items-center space-x-2 md:space-x-3 min-w-0">
              <div className="w-8 h-8 md:w-9 md:h-9 bg-white/5 rounded-lg md:rounded-xl flex items-center justify-center border border-white/10 shrink-0">
                <Clapperboard className="w-5 h-5" style={{ color: '#53fc18' }} />
              </div>
