  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-[100] pointer-events-none">
      <header className="w-full h-auto md:h-24 py-4 md:py-0 border-b border-white/10 bg-[#020610]/95 backdrop-blur-3xl shadow-[0_10px_40px_rgba(0,0,0,0.5)] pointer-events-auto">
        {/* Both names have to survive 375px side by side, and this tool's name is
            two words. The brand loses its wordmark below `sm` (the heart still
            links home) and the tool name drops a type step and truncates, which
            is what keeps the row from being clipped by the wrapper's
            overflow-x-hidden instead of merely overflowing. */}
