          ...
          <div className="py-1">
            {LANGUAGES.map((lang) => (
              <button
                ...
                className={`w-full flex items-center px-4 py-3 text-sm hover:bg-orange-950/30 transition-colors cursor-pointer text-left ${
                  currentLang === lang.code ? 'bg-orange-950/60 text-white' : 'text-gray-300'
                }`}
              >
