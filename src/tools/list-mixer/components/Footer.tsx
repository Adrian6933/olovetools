      ...
      <div className="flex flex-col items-center space-y-16 max-w-5xl px-8 text-center">
        ...
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-y-2 md:gap-y-6 gap-x-4 md:gap-x-8 text-gray-800 font-black text-[11px] md:text-xs tracking-widest pt-12 border-t border-white/5 w-full uppercase">
          ...
          <button
            ...
            className="w-full md:w-auto py-3 md:py-0 border-none bg-transparent hover:text-orange-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center font-black outline-none"
          >
          ...
          <a
            ...
            className="w-full md:w-auto py-3 md:py-0 hover:text-orange-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center font-black"
          >
          ...
          <button
            ...
            className="w-full md:w-auto py-3 md:py-0 border-none bg-transparent hover:text-orange-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer rounded-xl font-black outline-none"
          >
