...
export const LegalModal: React.FC<LegalModalProps> = ({ isOpen, onClose, title, content, t }) => {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-in fade-in duration-200">
      <div ref={modalRef} className="bg-[#020205] border border-white/10 p-8 rounded-3xl shadow-2xl w-full max-w-lg max-h-[80vh] overflow-y-auto animate-in zoom-in-95 duration-200 relative">
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <button 
            ...
            onClick={copyEmail}
            className="flex items-center space-x-3 text-fuchsia-400 hover:text-fuchsia-300 border-none bg-transparent outline-none transition-colors font-mono cursor-pointer"
          >
