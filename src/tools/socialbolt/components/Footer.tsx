...
export const Footer: React.FC<FooterProps> = ({ lang, t, onOpenModal }) => {
  return (
    <footer className="py-24 md:py-36 border-t border-white/5 flex flex-col items-center space-y-16 relative z-10 bg-[#040406] w-full">
      <div className="flex flex-col items-center space-y-16 max-w-5xl px-8 text-center">
        ...
        {/* El bloque SEO y las FAQ viven ahora en el cuerpo de la herramienta
            (con las FAQ en <details>), así que aquí no se repiten: index.astro
            ya vuelve a renderizarlas en el bloque SSR y triplicarlas era
            contenido duplicado puro. */}
