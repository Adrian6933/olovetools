  ...
  return (
    <div className="relative inline-block">
      <select
        ...
        className="appearance-none bg-white/5 border border-white/10 hover:border-amber-500/30 text-slate-200 hover:text-white px-4 py-2.5 pr-8 rounded-xl text-xs font-bold font-sans tracking-wide cursor-pointer transition-all outline-none"
      >
        {languages.map((lang) => (
