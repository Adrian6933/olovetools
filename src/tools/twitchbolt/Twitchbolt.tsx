...
const Twitchbolt: React.FC<TwitchboltProps> = ({ lang = 'en' }) => {
  ...
  const { t } = useTranslation(lang, 'twitchbolt');
            ...
            <div className="mt-6 w-full max-w-4xl animate-slide-up [animation-delay:200ms]">
               ...
               >
                  ...
                  <span className="text-sm font-medium text-gray-300">
                    {lang === 'es' ? '¿Quieres descargar clips de Kick?' : 'Looking to download Kick clips?'} <span className="text-[#53FC18] font-bold">Try KickBolt →</span>
                  </span>
               </a>
            </div>
