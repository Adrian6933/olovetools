      ...
      <div ref={modalRef} className="bg-[#050508] border border-white/10 p-8 rounded-3xl shadow-2xl w-full max-w-lg max-h-[80vh] overflow-y-auto animate-in zoom-in-95 duration-200 relative">
        ...
        <div className="border-t border-white/10 pt-6">
          ...
          <button 
            ...
            onClick={copyEmail}
            className="flex items-center space-x-3 text-cyan-400 hover:text-cyan-300 border-none bg-transparent outline-none transition-colors font-mono cursor-pointer"
          >
