...
/**
 * Se monta desde index.astro, no desde la isla. Dentro de la isla el pie
 * quedaba a media página, por encima de los CTAs cruzados, las herramientas
 * relacionadas, el contenido SEO SSR y el anuncio lateral. Los enlaces legales
 * son ahora páginas reales en vez de un modal, que es lo que hacen el resto de
 * las herramientas y lo único que puede rastrear un buscador.
 */
export const Footer: React.FC<FooterProps> = ({ lang, t }) => {
  ...
  return (
    <footer className="py-24 md:py-40 border-t border-white/5 flex flex-col items-center space-y-16 relative z-10 bg-[#040306] w-full">
