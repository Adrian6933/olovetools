  ...
  return (
    <footer className="py-24 md:py-36 border-t border-white/5 flex flex-col items-center space-y-16 relative z-10 bg-[#0a0408] w-full">
      <div className="flex flex-col items-center space-y-16 max-w-5xl px-8 text-center">
        ...
        {/* UuidGenerator.tsx ya renderiza el bloque SEO y la FAQ dentro de <main>,
            y index.astro los vuelve a imprimir en el bloque SSR. Repetirlos aquí
            ponía cada párrafo de la página tres veces. */}
        ...
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-y-2 md:gap-y-6 gap-x-4 md:gap-x-8 text-gray-800 font-black text-[11px] md:text-xs tracking-widest pt-12 border-t border-white/5 w-full uppercase">
          ...
          <button
            ...
            className="w-full md:w-auto py-3 md:py-0 border-none bg-transparent hover:text-violet-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center font-black outline-none"
          >
          ...
          <a
            ...
            className="w-full md:w-auto py-3 md:py-0 hover:text-violet-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center font-black"
          >
          ...
          <button
            ...
            className="w-full md:w-auto py-3 md:py-0 border-none bg-transparent hover:text-violet-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer rounded-xl font-black outline-none"
          >
