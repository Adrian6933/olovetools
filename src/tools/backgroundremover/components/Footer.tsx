...
export const Footer: React.FC<FooterProps> = ({ lang, t, onOpenModal }) => {
  return (
    <footer className="py-24 md:py-48 border-t border-white/5 flex flex-col items-center space-y-16 relative z-10 bg-[#050407] w-full">
      <div className="flex flex-col items-center space-y-16 max-w-5xl px-8 text-center">
        ...
        >
          <div className="w-12 h-12 bg-fuchsia-600 rounded-[1.2rem] flex items-center justify-center group-hover:rotate-12 transition-transform shadow-[0_15px_30px_-5px_rgba(236,72,153,0.5)]">
          ...
          <div className="flex items-center space-x-1 font-black text-4xl tracking-tighter">
            <span className="text-white transition-all group-hover:text-fuchsia-400">oLove</span>
            <span className="text-fuchsia-400 group-hover:translate-x-1 group-hover:text-white transition-all">Tools</span>
          </div>
        </a>
        ...
        <div className="flex flex-col md:flex-row flex-wrap items-center justify-center gap-y-2 md:gap-y-6 gap-x-4 md:gap-x-8 text-gray-800 font-black text-[11px] md:text-xs tracking-widest pt-12 uppercase border-t border-white/5 w-full">
          ...
          <button 
            ...
            className="w-full md:w-auto py-3 md:py-0 hover:text-fuchsia-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center font-black"
          >
          ...
          <a 
            ...
            className="w-full md:w-auto py-3 md:py-0 hover:text-fuchsia-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer whitespace-nowrap rounded-xl text-center"
          >
          ...
          <button 
            ...
            className="w-full md:w-auto py-3 md:py-0 hover:text-fuchsia-400 active:bg-white/5 active:scale-95 transition-all cursor-pointer rounded-xl font-black"
          >
            {t.emailAddress}
          </button>
        </div>
