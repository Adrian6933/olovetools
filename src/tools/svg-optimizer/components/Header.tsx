 ...
 * build used lucide's `Maximize2` here, which is a fullscreen icon and says
 * nothing about optimizing an SVG.
 */
const OptimizerMark = () => (
  <svg viewBox="0 0 24 24" className="w-5 h-5 text-cyan-400" fill="none" aria-hidden="true">
    <path
      d="M4 18c3-9 13-9 16 0"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <rect x="2" y="16" width="4" height="4" rx="1" fill="currentColor" />
    <rect x="18" y="16" width="4" height="4" rx="1" fill="currentColor" />
    <path d="M12 4v5M9.5 7 12 9.5 14.5 7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
