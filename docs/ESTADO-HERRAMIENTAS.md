...
| compresssnap | pasa (lógica) | Sanitiza dimensiones restauradas y valores no finitos sin limitar la fuente antes del reescalado: una panorámica 20.000×1.000 al 50 % conserva 10.000×500. | Prueba determinista de `targetSize`, `npx tsc --noEmit` y revisión estática. Pendiente prueba manual de archivos grandes, transparencia y descarga en Chromium/Firefox/Safari. | L03 |
